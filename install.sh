...
5. Please consider specific instructions at the start or at the end of the text. Specifically, if you see some sentences contained in parenthesis you need to follow the instructions provided e.g. you may see something like {return the text all upper case}, so please pay attention to what the user is asking. Otherwise ignore this point.
