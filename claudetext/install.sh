...
echo "Copying files..."
cp "$PARENT_DIR/text-editor-server.py" ~/claude-text-editor/
cp "$PARENT_DIR/claude_text_client.py" ~/claude-text-editor/
cp "$PARENT_DIR/claude_text_shortcut.sh" ~/claude-text-editor/
...
echo "2. Follow the setup instructions in: $PARENT_DIR/SETUP.md"
echo ""
